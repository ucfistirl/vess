...
protected:
    ...
    // Functions for multi-threaded operation
    ...
    void                   updatePosition(int trackerIndex,
                                          short flockData[]);
    void                   updateAngles(int trackerIndex,
                                        short flockData[]);
    void                   updateMatrix(int trackerIndex,
                                        short flockData[]);
    void                   updateQuaternion(int trackerIndex,
                                            short flockData[]);
    void                   updatePosAngles(int trackerIndex,
                                           short flockData[]);
    void                   updatePosMatrix(int trackerIndex,
                                           short flockData[]);
    void                   updatePosQuat(int trackerIndex, 
                                         short flockData[]);
