...
// ------------------------------------------------------------------------
DWORD WINAPI vsPhaseSpaceMD::threadLoop(void *objectPtr)
{
    ...
    // Free the tracker data critical section
...
void vsPhaseSpaceMD::forkTracking()
{
    ...
    // Create a critical section to control access to the main tracker data 
    // in order to prevent race conditions
    InitializeCriticalSection(&criticalSection);

    // Create the worker thread
    threadHandle = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)threadLoop, 
        this, 0, &threadID);
    ...
    else
    {
        ...
        // Destroy the tracker data critical section
...
void vsPhaseSpaceMD::update()
{
    ...
    if (threaded)
    {
        ...
        // sure to use the tracker data critical section to avoid race 
        // conditions.
        EnterCriticalSection(&criticalSection);
