...
// for undesired data values.  Under Windows, this returns the total size
// of the virtual desktop, not the size of any one screen.
// ------------------------------------------------------------------------
...
// ------------------------------------------------------------------------
// Internal function
// Returns the index of this screen
// ------------------------------------------------------------------------
int vsScreen::getBaseLibraryObject()
{
    return screenIndex;
}
