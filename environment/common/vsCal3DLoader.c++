...
void vsCal3DLoader::addFilePath(const char *dirName)
{
   ...
   // Tell the loaders to add this directory to their listings
                                                    ...
                                                    *skeletonKinematics)
{
    ...
    for (index = 0; (index < animationCount) && (!found); index++)
    {
        ...
        strncpy(animationName, filename, 500);
        ...
        loop = (strlen(animationName) - 1);
        while ((loop != -1) && (animationName[loop] != '/'))
            loop--;
              
        animName = &(animationName[loop+1]);
        
        // Cut the last four letters off of the animationName (the file
        // extension, and the period before it)
        animName[strlen(animationName)-1] = '\0';
        animName[strlen(animationName)-1] = '\0';
        animName[strlen(animationName)-1] = '\0';
        animName[strlen(animationName)-1] = '\0';
                
        // Check to see if the animation name and the name given are equal
...
//------------------------------------------------------------------------
// Returns the vsGrowableArray with the list of animation filenames.
//------------------------------------------------------------------------
vsGrowableArray *vsCal3DLoader::getAnimationNameList()
{
