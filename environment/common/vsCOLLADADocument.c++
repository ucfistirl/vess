...
// ------------------------------------------------------------------------
// Constructor for a COLLADA document.  Creates all the object libraries
// and parses the given XML document as a COLLADA file
// ------------------------------------------------------------------------
vsCOLLADADocument::vsCOLLADADocument(atXMLDocument * doc, atList *paths)
{
    atString *path;

    // Clone the path list
    pathList = new atList();
    path = (atString *)paths->getFirstEntry();
    while (path != NULL)
    {
       pathList->addEntry(new atString(*path));
       path = (atString *)paths->getNextEntry();
    }
...
// ------------------------------------------------------------------------
// Denstructor for the COLLADA document.  Cleans up the object libraries
// and removes any data created during the loading process
// ------------------------------------------------------------------------
...
// ------------------------------------------------------------------------
const char *vsCOLLADADocument::getClassName()
{
   return "vsCOLLADADocument";
}

// ------------------------------------------------------------------------
// Often, there will be unnamed or unidentified objects in the file.  This
// method simply makes up a name/ID for them that is unique for this
// document, so the objects can be placed in the appropriate library map
// ------------------------------------------------------------------------
atString vsCOLLADADocument::getUnnamedName()
{
    char name[64];
...
// ------------------------------------------------------------------------
atString vsCOLLADADocument::findFile(const char *filename)
{
    atString fileStr;
...
// ------------------------------------------------------------------------
vsCOLLADANode *vsCOLLADADocument::getSkeletonRoot(atString id)
{
    char *idStr;
    atString newID;
    vsCOLLADANode *node;
...
// ------------------------------------------------------------------------
bool vsCOLLADADocument::isSkeletonRoot(vsComponent *node)
{
...
// identifier
// ------------------------------------------------------------------------
vsSkeleton *vsCOLLADADocument::getSkeleton(atString id)
{
    char *idStr;
    atString newID;
...
// ------------------------------------------------------------------------
vsCOLLADAEffect *vsCOLLADADocument::getEffect(atString id)
{
    char *idStr;
    atString newID;
...
// Returns a COLLADA effect object specified by the given identifier
// ------------------------------------------------------------------------
vsCOLLADAEffect *vsCOLLADADocument::getMaterial(atString id)
{
    char *idStr;
    atString newID;
...
// ------------------------------------------------------------------------
vsCOLLADAController *vsCOLLADADocument::getController(atString id)
{
    char *idStr;
    atString newID;
...
// ------------------------------------------------------------------------
vsCOLLADAGeometry *vsCOLLADADocument::getGeometry(atString id)
{
    char *idStr;
    atString newID;
...
// ------------------------------------------------------------------------
vsCOLLADANode *vsCOLLADADocument::getVisualScene(atString id)
{
    char *idStr;
    atString newID;
...
// ------------------------------------------------------------------------
int vsCOLLADADocument::getIntToken(atStringTokenizer *tokens)
{
    atString *tempStr;
    int value;
...
// returning it
// ------------------------------------------------------------------------
double vsCOLLADADocument::getFloatToken(atStringTokenizer *tokens)
{
    atString *tempStr;
    double value;
...
// ------------------------------------------------------------------------
atVector vsCOLLADADocument::parseVector(atXMLDocument *doc,
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::unrefDeleteMap(atMap *map)
{
    atList *keys;
    atList *values;
    atString *key;
...
// object
// ------------------------------------------------------------------------
void vsCOLLADADocument::processAnimation(atXMLDocument *doc,
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryAnimations(atXMLDocument *doc,
                                               atXMLDocumentNodePtr current)
{
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryAnimationClips(atXMLDocument *doc,
                                                   atXMLDocumentNodePtr current)
{
}
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryCameras(atXMLDocument *doc,
                                            atXMLDocumentNodePtr current)
{
}
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processController(atXMLDocument *doc,
                                        atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
    char *attr;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryControllers(atXMLDocument *doc,
                                                atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
vsCOLLADAEffectParameter *vsCOLLADADocument::processNewParam(
                                                 atXMLDocument *doc,
                                                 atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processMaterialAttributes(atXMLDocument *doc,
                                                atXMLDocumentNodePtr current,
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processCommonEffect(atXMLDocument *doc,
                                          atXMLDocumentNodePtr current,
                                          atString *id)
{
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processGLSLEffect(atXMLDocument *doc,
                                        atXMLDocumentNodePtr current)
{
}
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processEffect(atXMLDocument *doc,
                                    atXMLDocumentNodePtr current)
{
    char *attr;
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryEffects(atXMLDocument *doc,
                                            atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
...
// library and all the objects it contains
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryGeometries(atXMLDocument *doc,
                                               atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
    vsCOLLADAGeometry *geom;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processImage(atXMLDocument *doc,
                                   atXMLDocumentNodePtr current)
{
    atString *id;
    atXMLDocumentNodePtr child;
...
// library and all the objects it contains
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryImages(atXMLDocument *doc,
                                           atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLight(atXMLDocument *doc,
                                   atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
...
// library and all the objects it contains
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryLights(atXMLDocument *doc,
                                           atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processSetParam(atXMLDocument *doc,
                                      atXMLDocumentNodePtr current,
                                      vsCOLLADAEffect *effect)
{
    ...
    {
        notify(AT_WARN, "vsCOLLADADocument::processSetParam:"
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processMaterial(atXMLDocument *doc,
                                      atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
...
// library and all the objects it contains
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryMaterials(atXMLDocument *doc,
                                              atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processInstanceMaterial(atXMLDocument *doc,
                                              atXMLDocumentNodePtr current,
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processBindMaterial(atXMLDocument *doc,
                                          atXMLDocumentNodePtr current,
                                          vsComponent *geomComponent)
{
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
vsSkeleton *vsCOLLADADocument::createSkeleton(vsCOLLADANode *root,
                                            vsCOLLADASkin *skin)
{
    atArray *bones;
    int i;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processInstanceController(atXMLDocument *doc,
                                                atXMLDocumentNodePtr current,
            ...
            if (strcmp(doc->getNodeName(child), "skeleton") == 0)
            {
                ...
                if (thisSkeleton == NULL)
                {
                    ...
                    if (skeletonRoot != NULL)
                    {
                        ...
                        // Add the skeleton to the document's skeleton list
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processInstanceGeometry(atXMLDocument *doc,
                                              atXMLDocumentNodePtr current,
                                              vsCOLLADANode *parent)
{
    char *attr;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processNodePass1(atXMLDocument *doc,
                                       atXMLDocumentNodePtr current,
                                       vsCOLLADANode *parent)
{
    char *attr;
...
// node
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLOD(char *properties, vsCOLLADANode *node)
{
    char *ptr;
    int rangeCount;
    int i;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processNodeFCTechnique(atXMLDocument *doc,
                                             atXMLDocumentNodePtr current,
                                             vsCOLLADANode *node)
{
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processNodeExtra(atXMLDocument *doc,
                                       atXMLDocumentNodePtr current,
                                       vsCOLLADANode *node)
{
    atXMLDocumentNodePtr technique;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processNodePass2(atXMLDocument *doc,
                                       atXMLDocumentNodePtr current,
                                       vsCOLLADANode *parent,
                                       int thisIndex)
{
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryNodes(atXMLDocument *doc,
                                          atXMLDocumentNodePtr current)
{
}
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processVisualScene(atXMLDocument *doc,
                                         atXMLDocumentNodePtr current)
{
    char *attr;
    atString *sceneID;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processLibraryVisualScenes(atXMLDocument *doc,
                                                 atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::addChannelsFromAnimation(vsList *list,
                                               vsCOLLADAAnimation *anim)
{
    int i;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::buildAnimations(vsList *skeletonList,
                                      vsList *skelKinList)
{
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::buildCharacter(vsCOLLADANode *sceneRootNode,
                                     atMatrix sceneMat)
{
    vsSkeleton *skeleton;
    vsList *skelKinList;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processScene(atXMLDocument *doc,
                                   atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
    char *attr;
...
// ------------------------------------------------------------------------
void vsCOLLADADocument::processAsset(atXMLDocument *doc,
                                   atXMLDocumentNodePtr current)
{
    atXMLDocumentNodePtr child;
...
// ------------------------------------------------------------------------
// Initiates parsing of the given XML document as a COLLADA document
// ------------------------------------------------------------------------
void vsCOLLADADocument::parseDocument(atXMLDocument *doc)
{
...
// character (if any)
// ------------------------------------------------------------------------
vsComponent *vsCOLLADADocument::getScene()
{
...
// ------------------------------------------------------------------------
vsCharacter *vsCOLLADADocument::getCharacter()
{
